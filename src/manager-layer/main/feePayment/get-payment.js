...
const { PaymentRetrivedPublisher } = require("../../route-events/publishers");
...
const { dbGetPayment } = require("dbLayer");

class GetPaymentManager extends FeePaymentManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbGetPayment function to get the payment and return the result to the controller
    const payment = await dbGetPayment(this);

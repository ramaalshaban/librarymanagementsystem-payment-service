...
const { dbDeleteFeepayment } = require("dbLayer");

class DeleteFeePaymentManager extends FeePaymentManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbDeleteFeepayment function to delete the feepayment and return the result to the controller
    const feepayment = await dbDeleteFeepayment(this);
...
module.exports = DeleteFeePaymentManager;

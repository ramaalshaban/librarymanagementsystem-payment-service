...
const { dbDeleteFeeevent } = require("dbLayer");

class DeleteFeeEventManager extends FeeEventManager {
  ...
  async doBusiness() {
    // Call DbFunction
    // make an awaited call to the dbDeleteFeeevent function to delete the feeevent and return the result to the controller
    const feeevent = await dbDeleteFeeevent(this);
...
module.exports = DeleteFeeEventManager;

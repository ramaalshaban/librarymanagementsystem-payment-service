...
console.log("Starting librarymanagementsystem-payment-service service...");
...
const start = async () => {
  process.title = "node-librarymanagementsystem-payment-service";
  ...
  try {
    ...
    await setRedisData(
      "librarymanagementsystem-payment-service:start",
      today.toUTCString(),
    );
    console.log(
      "Service start datetime is written to Redis key librarymanagementsystem-payment-service:start",
      today.toUTCString(),
    );
  } catch (err) {
  ...
  console.log(
    "librarymanagementsystem-payment-service is listening HTTP/REST port " +
...
/* starting the server librarymanagementsystem-payment-service .... */
start();

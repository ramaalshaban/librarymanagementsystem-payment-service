...
class UpdateFeePaymentMcpController extends PaymentMcpController {
  constructor(params) {
    super("updateFeePayment", "updatefeepayment", params);
    this.dataName = "feePayment";
    this.crudType = "update";
  }

  createApiManager() {
    return new UpdateFeePaymentManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    parameters: UpdateFeePaymentMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const updateFeePaymentMcpController = new UpdateFeePaymentMcpController(
        mcpParams,
      );
      try {
        const result = await updateFeePaymentMcpController.processRequest();
        //return UpdateFeePaymentMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",

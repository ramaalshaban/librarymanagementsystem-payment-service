...
class CreatePaymentMcpController extends PaymentMcpController {
  constructor(params) {
...
module.exports = (headers) => {
  return {
    ...
    controller: async (mcpParams) => {
      ...
      const createPaymentMcpController = new CreatePaymentMcpController(
        mcpParams,
      );
      try {
        const result = await createPaymentMcpController.processRequest();

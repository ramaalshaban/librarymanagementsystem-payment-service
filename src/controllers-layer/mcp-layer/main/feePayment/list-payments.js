...
class ListPaymentsMcpController extends PaymentMcpController {
  constructor(params) {
...
module.exports = (headers) => {
  return {
    ...
    controller: async (mcpParams) => {
      ...
      const listPaymentsMcpController = new ListPaymentsMcpController(
        mcpParams,
      );
      try {
        const result = await listPaymentsMcpController.processRequest();

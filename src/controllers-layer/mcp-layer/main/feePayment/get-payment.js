...
class GetPaymentMcpController extends PaymentMcpController {
  constructor(params) {
...
module.exports = (headers) => {
  return {
    ...
    controller: async (mcpParams) => {
      ...
      const getPaymentMcpController = new GetPaymentMcpController(mcpParams);
      try {
        const result = await getPaymentMcpController.processRequest();

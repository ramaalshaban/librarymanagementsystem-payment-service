...
class GetPaymentByPaymentIdMcpController extends PaymentMcpController {
  constructor(params) {
    super("getPaymentByPaymentId", "getpaymentbypaymentid", params);
    this.dataName = "feePayment";
    this.crudType = "get";
  }

  createApiManager() {
    return new GetPaymentByPaymentIdManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    description: "",
    parameters: GetPaymentByPaymentIdMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const getPaymentByPaymentIdMcpController =
        new GetPaymentByPaymentIdMcpController(mcpParams);
      try {
        const result =
          await getPaymentByPaymentIdMcpController.processRequest();
        //return GetPaymentByPaymentIdMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",

...
class DeletePaymentMcpController extends PaymentMcpController {
  constructor(params) {
...
module.exports = (headers) => {
  return {
    ...
    controller: async (mcpParams) => {
      ...
      const deletePaymentMcpController = new DeletePaymentMcpController(
        mcpParams,
      );
      try {
        const result = await deletePaymentMcpController.processRequest();

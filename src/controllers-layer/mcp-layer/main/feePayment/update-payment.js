...
class UpdatePaymentMcpController extends PaymentMcpController {
  constructor(params) {
...
module.exports = (headers) => {
  return {
    ...
    controller: async (mcpParams) => {
      ...
      const updatePaymentMcpController = new UpdatePaymentMcpController(
        mcpParams,
      );
      try {
        const result = await updatePaymentMcpController.processRequest();

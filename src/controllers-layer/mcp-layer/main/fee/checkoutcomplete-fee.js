...
class CheckoutcompleteFeeMcpController extends PaymentMcpController {
  constructor(params) {
    super("checkoutcompleteFee", "checkoutcompletefee", params);
    this.dataName = "fee";
    this.crudType = "update";
  }

  createApiManager() {
    return new CheckoutcompleteFeeManager(this.request, "mcp");
  }
...
module.exports = (headers) => {
  return {
    ...
    description: "",
    parameters: CheckoutcompleteFeeMcpController.getInputScheme(),
    controller: async (mcpParams) => {
      mcpParams.headers = headers;
      const checkoutcompleteFeeMcpController =
        new CheckoutcompleteFeeMcpController(mcpParams);
      try {
        const result = await checkoutcompleteFeeMcpController.processRequest();
        //return CheckoutcompleteFeeMcpController.getOutputSchema().parse(result);
        return {
          content: [
            {
              type: "text",

...
class DbListPaymentsCommand extends DBGetListMongooseCommand {
  constructor(input) {
    super(input);
    this.commandName = "dbListPayments";
...
const dbListPayments = (input) => {
  const dbGetListCommand = new DbListPaymentsCommand(input);
  return dbGetListCommand.execute();
};

module.exports = dbListPayments;

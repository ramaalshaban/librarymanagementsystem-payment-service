...
describe("ListFeeEvents", () => {
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/FeeEvent/list-feeevents",
      {

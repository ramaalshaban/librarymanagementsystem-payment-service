...
describe("PaymentMethodManager", () => {
  ...
  beforeEach(() => {
    ...
    ManagerClass = proxyquire(
      "../../../../src/manager-layer/main/PaymentMethod/PaymentMethodManager",
      {
  ...
  describe("constructor", () => {
    it("should initialize properties correctly", () => {
      ...
      expect(instance).to.have.property("objectName", "paymentMethod");
      expect(instance).to.have.property("modelName", "PaymentMethod");

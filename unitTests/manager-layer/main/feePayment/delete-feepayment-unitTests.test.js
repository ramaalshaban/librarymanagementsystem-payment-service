...
describe("DeleteFeePayment", () => {
  ...
  beforeEach(() => {
    ...
    ControllerClass = proxyquire(
      "../../../../src/manager-layer/main/FeePayment/delete-feepayment",
      {
        "./FeePaymentManager": class {
